<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\phpStudy\WWW\APP./application/admin\view\version\index.html";i:1533022708;s:62:"D:\phpStudy\WWW\APP./application/admin\view\template\base.html";i:1531361201;s:73:"D:\phpStudy\WWW\APP./application/admin\view\template\javascript_vars.html";i:1530516289;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><?php echo $vo['update_log']; ?></td>
            <td>
                <?php if($vo['type'] == '0'): ?>静默更新<?php endif; if($vo['type'] == '1'): ?>强制更新<?php endif; if($vo['type'] == '2'): ?>选择更新<?php endif; ?>
            </td>
