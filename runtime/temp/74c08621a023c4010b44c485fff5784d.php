<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\phpStudy\WWW\APP./application/admin\view\article\edit.html";i:1531364824;s:62:"D:\phpStudy\WWW\APP./application/admin\view\template\base.html";i:1531361201;s:73:"D:\phpStudy\WWW\APP./application/admin\view\template\javascript_vars.html";i:1530516289;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
       ...
       <!--  <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="类型" name="keyword" value="<?php echo isset($vo['keyword']) ? $vo['keyword'] :  ''; ?>" >
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
         ...
         <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <textarea class="textarea" style="display: none"  placeholder=""  onKeyUp="textarealength(this, 100)"><?php echo isset($vo['content']) ? $vo['content'] :  ''; ?></textarea>
                <!-- <p class="textarea-numberbar"><em class="textarea-length">0</em>/100</p> -->
                <!-- 加载编辑器的容器 -->
                <script id="container" name="content" type="text/plain"><?php echo isset($vo['content']) ? $vo['content'] :  ''; ?></script>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
