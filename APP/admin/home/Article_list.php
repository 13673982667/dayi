...
if (!isset($_SESSION['usernc']) && empty($_SESSION['usernc'])) {
    ...
    $pageSize=3;        //每页显示的记录数
    $query="select * from kq_article  order by addtime desc" ;
    //总记录数
    ...
    $sql="select * from kq_article order by addtime desc limit {$offset},{$pageSize}";
...
<!--  <button class="btn button_btn btn-danger" type="button" onclick=""><i class="fa fa-trash-o"></i>&nbsp;删除</button>-->
  <span class="submenu"><a href="../home/add_Article.html" name="add_Article.php" class="btn button_btn bg-deep-blue" title="添加文章"><i class="fa  fa-edit"></i>&nbsp;添加文章</a></span>
     <div class="search  clearfix">
         <label class="label_name">文章检索：</label><input name="search" type="text" placeholder="请输入文章标题" class="form-control col-xs-6"/><button class="btn button_btn bg-deep-blue " id="submit"   type="button"><i class="fa  fa-search"></i>&nbsp;搜索</button>
     </div>
 </div>
 <!--列表展示-->
...
<!--          <th width="30"><label><input type="checkbox" class="ace"><span class="lbl"></span></label></th>-->
   ...
   <tr id="tr" style="text-align: center;" >
    ...
    <th id="cont" style="text-align: center;"><?php  echo $value['cont']?></th>
