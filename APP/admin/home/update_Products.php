...
$id = $_GET['id'];
$sql = "select * from kq_products where id = '$id'" ;
    ...
    <div class="add_style">
        <ul>
            <form action="../admin/edit-article.php" method="post" enctype="multipart/form-data">
                ...
                <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>项目名称：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="title" type="text" value="<?php echo $data['title']?>"  class="col-xs-6"/></div>  </li>
              <!--   <li class="clearfix">
